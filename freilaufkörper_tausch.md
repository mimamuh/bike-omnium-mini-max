# DT Swiss Micro-Spline-Umrüstkit für das Omnium-Carbon-Hinterrad

## Zweck

Umrüstung des vorhandenen Shimano-HG-Freilaufkörpers auf Shimano Micro Spline.
...
Nabenkörper laut DT-Swiss-Stückliste:
...
| --- | --- | --- | --- |
| `HWA00100S7841S` | `RW ADAPT WP XXX/12 L B` | 1 | ST |
| `HCDXXX00N2884S` | `STAR RATCHET SL 36 TEETH` | 2 | ST |
| `HXDXXX00N1087S` | `SPRING HÜGI 240/FR/240S/440` | 2 | ST |
| `HCDXXX00S1077S` | `SPACER ALLOY 15,4MM B` | 1 | ST |
| `HWH07732S0001S` | `RW HUBSHELL 350 IS R32 BM WS` | 1 | ST |
| `HSOXXX00N1031S` | `SEAL HUB/ROTOR (Ø30x36x2.5mm)` | 1 | ST |
| `HXDXXX00N1131S` | `RING NUT STEEL M34X1 240` | 1 | ST |
| `HCDXXX00S1083S` | `SHIM RING Ø28/20X0.5MM` | 1 | ST |
| `HSBXXX00N2336S` | `B.BEARING 6902 ESB/ESNB L` | 2 | ST |
| `HCCXXX00S2216S` | `RW AXLE AL XXXMM Ø15/42.1MM` | 1 | ST |
| `HWA00100S7892S` | `RW ADAPT WP XXX/12 R B` | 1 | ST |
| `HWRABL00S1239S` | `FB W MTB SHI RAT AL LI SL B` | 1 | ST |
...
```text
service.de@dtswiss.com
```

Übermittelte Anhänge zur selben Auskunft:

- Stückliste der identifizierten Nabe
- Produktfoto des Umrüstkits `HWYABL00S2562S`

### Herstellerangabe

DT Swiss bestätigt:

1. Die Nabe ist eine OEM-Version der DT Swiss 350.
2. Es ist das klassische Ratchet System verbaut.
3. Es handelt sich nicht um ein Ratchet-DEG-System.
4. Für die Umrüstung auf Shimano Micro Spline wird ausschließlich das oben genannte Umrüstkit benötigt.
...
- benötigte Werkzeuge
- Montage-Drehmomente
- genaue Aufschlüsselung aller Produktkürzel
- ausdrückliche Aussage, ob vorhandene Ratchet-Komponenten beim Umbau weiterverwendet werden

Die grundsätzliche Auswahl des Umrüstkits wurde von DT Swiss für die identifizierte Nabe bestätigt.
